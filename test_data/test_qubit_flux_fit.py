...
PATH_TESTING_DATA = TEST_FILE_DIR / "qubit_flux"
...
if __name__ == "__main__":
    """Run fits for all datasets stored in RESULT_FOLDERS and generate plots of the fit
    on top a heatmap of the signal. This is to help assess whether a fit is good or not.

    This is intended for use while working on the qubit flux protocol. The
    ...
    output_base = Path(__file__).parent / "regression_fit_plots/qubit_flux"
        ...
        for qubit in expected.frequency:
            ...
            def _filtered(params):
                ...
                return {
                    ...
                    if k not in {"xj", "d", "crosstalk_element", "charging_energy"}
                }
